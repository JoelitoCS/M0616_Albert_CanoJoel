...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO modulos (nombre, codigo, descripcion) VALUES (?, ?, ?)");

    $stmt->bind_param("sss", $nom, $codigo, $desc);
    $stmt->execute();
...
<div class="form-container">
    <form method="POST">
        <h1 style="margin-bottom:30px; font-size:20px;">Añadir Módulo</h1>
